	...
	<body>
		...
		<div class="content">
			...
			<div class="userInfo">
			    ...
			    <?php else:?>
			        Да<br>
			        <a href="adminpage.php">Перейти на панель админа</a><br>
			    <?php endif;?>
			    <a href="game.php">Нажмите, чтобы сыграть в игру</a><br>
			    <a href="updateuser.php?id=<?=$_COOKIE['user']?>">Нажмите, чтобы изменить данные</a><br>
			    <a href="php/exit.php">Нажмите, чтобы выйти из профиля</a>
			</div>
		</div>
	</body>
</html>